function Footer() {
  const sections = [
...

    {
      ...
      links: ["Características técnicas", "Câmera", "Bateria", "Dispaly"],
    },
  ...
  const bottomLinks = ["Política de Privacidade", "Termos de Uso", "Vendas"];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 ">
        ...
        <div className="border-t border-gray-800 pt-6">
          ...
          <p className="text-xs text-gray-500 mt-6  ">
            {" "}
            Site criado para fins educacionais - Kiara Toster 
          </p>
        </div>
      </div>
    </footer>
